...
Bu depo (repository), SwiftUI öğrenirken izlediğim Paul Hudson kanalından elde etmiş olduğum projeleri içerir.

## 📂 İçerik Yapısı

### 01-İçerdiği Projeler
- [x] **WeSplit** 
- [x] **GuessTheFlag** Kullanıcı ekranda beliren ülke ismine ait bayrağı bulmaya çalışır.
...
- **Dil:** Swift 6.1.2
- **Platform:** Xcode Playground
- **Versiyon Kontrol:** Git & Fork
